...
const addColors = (arr: WatchedStatusCount[]) =>
    arr.map((cat: any) => ({
        fill: `var(--color-${cat.Status.toLowerCase().replace(/\s+/g, "")})`,
        ...cat,
    }));
            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-between gap-2">
                <Card className="w-full lg:w-1/2">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Status of jobs in your watchlist
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="w-full lg:w-1/2">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Status of companies in your watchlist
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <ChartContainer config={chartConfig}>
